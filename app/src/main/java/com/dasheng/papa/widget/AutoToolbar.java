...
public class AutoToolbar extends Toolbar {
    ...
    public AutoToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray menuA = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Theme1,
                defStyleAttr, R.style.ThemeOverlay_AppCompat);
        int menuTextAppearance = menuA.getResourceId(R.styleable.Theme1_actionBarTheme1,
