...
public class ExampleUnitTest {
    ...
    public void gsonTest() {
        ApiListResBean<ResponseItemBean> apiListResBean = new ApiListResBean<>();
        apiListResBean.setMsg("sead");
        apiListResBean.setStatus(1);
        List<ResponseItemBean> list = new ArrayList<>();
        for (int i = 9; i > 0; i--) {
            ResponseItemBean responseItemBean = new ResponseItemBean();
            responseItemBean.setTitle(i + "");
            list.add(responseItemBean);
        }
        apiListResBean.setRes(list);
        String gsonString = GsonUtil.GsonString(apiListResBean.getRes());
        System.out.println("gsonString   " + gsonString);
        List<ResponseItemBean> beanList = GsonUtil.GsonToList(gsonString, ResponseItemBean.class);
        System.out.println("beanList : " + beanList.size());
        for (int i = beanList.size() - 1; i >= 0; i--) {
            System.out.println("bean: " + beanList.get(i));
        }
        /*String json = "[{\"id\":\"2\",\"name\":\"\\u5a31\\u4e50\\u7cbe\\u9009\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104422453.png\"},{\"id\":\"1\"," +
                "\"name\":\"\\u793e\\u4f1a\\u70ed\\u70b9\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104357946.png\"},{\"id\":\"7\"," +
                "\"name\":\"\\u798f\\u5229\\u89c6\\u9891\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104535113.png\"},{\"id\":\"4\"," +
                "\"name\":\"\\u8d22\\u7ecf\\u770b\\u70b9\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104601601.png\"},{\"id\":\"8\"," +
                "\"name\":\"\\u4f53\\u80b2\\u8d44\\u8baf\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104642222.png\"},{\"id\":\"3\"," +
                "\"name\":\"\\u5947\\u95fb\\u8da3\\u4e8b\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/17062310445294.png\"},{\"id\":\"6\"," +
                "\"name\":\"\\u539f\\u521b\\u6076\\u641e\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104516154.png\"},{\"id\":\"5\"," +
                "\"name\":\"\\u641e\\u7b11\\u6bb5\\u5b50\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/170623104620168.png\"},{\"id\":\"9\"," +
                "\"name\":\"\\u7f8e\\u5973\\u56fe\\u96c6\"," +
                "\"picture\":\"\\/upload\\/a\\/170623\\/17062310465353.png\"}]";
        List<ResponseItemBean> responseItemBeen = GsonUtil.GsonToList(json, ResponseItemBean.class);
        System.out.println("responseItemBeen:" + (responseItemBeen == null ? 0 : responseItemBeen.size()));*/
    }
}